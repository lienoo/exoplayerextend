 ...
 * </ul>
 */
public final class ExtendExtractorsFactory implements ExtractorsFactory {
    ...
    private static final ExtensionLoader FLAC_EXTENSION_LOADER =
            new ExtensionLoader(ExtendExtractorsFactory::getFlacExtractorConstructor);
    private static final ExtensionLoader MIDI_EXTENSION_LOADER =
            new ExtensionLoader(ExtendExtractorsFactory::getMidiExtractorConstructor);
    ...
    public ExtendExtractorsFactory() {
    ...
    public synchronized ExtendExtractorsFactory setConstantBitrateSeekingEnabled(
     ...
     */
    @CanIgnoreReturnValue
    public synchronized ExtendExtractorsFactory setConstantBitrateSeekingAlwaysEnabled(
     ...
     */
    @CanIgnoreReturnValue
    public synchronized ExtendExtractorsFactory setAdtsExtractorFlags(
     ...
     */
    @CanIgnoreReturnValue
    public synchronized ExtendExtractorsFactory setAmrExtractorFlags(@AmrExtractor.Flags int flags) {
        this.amrFlags = flags;
        return this;
    }
     ...
     */
    @CanIgnoreReturnValue
    public synchronized ExtendExtractorsFactory setFlacExtractorFlags(
     ...
     */
    @CanIgnoreReturnValue
    public synchronized ExtendExtractorsFactory setMatroskaExtractorFlags(
     ...
     */
    @CanIgnoreReturnValue
    public synchronized ExtendExtractorsFactory setMp4ExtractorFlags(@Mp4Extractor.Flags int flags) {
        this.mp4Flags = flags;
        return this;
    }
     ...
     */
    @CanIgnoreReturnValue
    public synchronized ExtendExtractorsFactory setFragmentedMp4ExtractorFlags(
     ...
     */
    @CanIgnoreReturnValue
    public synchronized ExtendExtractorsFactory setMp3ExtractorFlags(@Mp3Extractor.Flags int flags) {
        mp3Flags = flags;
        return this;
    }
     ...
     */
    @CanIgnoreReturnValue
    public synchronized ExtendExtractorsFactory setTsExtractorMode(@TsExtractor.Mode int mode) {
        tsMode = mode;
        return this;
    }
     ...
     */
    @CanIgnoreReturnValue
    public synchronized ExtendExtractorsFactory setTsExtractorFlags(
     ...
     */
    @CanIgnoreReturnValue
    public synchronized ExtendExtractorsFactory setTsExtractorTimestampSearchBytes(
    ...
    public synchronized Extractor[] createExtractors(
        ...
        if ( uriInferredFileType == FileTypes.UNKNOWN )
        {
            ...
            {
                extractors.add(new H264Extractor());
            }
        }
